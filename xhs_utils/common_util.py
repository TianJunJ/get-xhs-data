...
def init(media_path: str, excel_path: str):
    ...
    media_base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), media_path))
    excel_base_path = os.path.abspath(os.path.join(os.path.dirname(__file__), excel_path))
